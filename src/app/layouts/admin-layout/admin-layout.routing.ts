...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'superior-collection/search/:id/:query', component: SuperiorCollectionComponent },
    { path: 'inferior-collection/:id', component: InferiorCollectionComponent },
    { path: 'inferior-collection/search/:id/:query', component: InferiorCollectionComponent },
    { path: 'inferior-collection/:id/:item', component: InferiorCollectionComponent },
    { path: 'inferior-collection/search/:id/:item/:query', component: InferiorCollectionComponent },
    ...
    { path: 'inferior-samples/search/:id/:query', component: InferiorSamplesComponent },
    { path: 'inferior-samples/:id/:item', component: InferiorSamplesComponent },
    ...
    { path: 'inferior-stamp/search/:id/:query', component: InferiorStampComponent },
